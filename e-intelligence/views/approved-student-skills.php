                    ...
                    <div class="card-header">
                        ...
                        <div class="btn-actions-pane-right">
                            <div role="group" class="btn-group-sm btn-group">
                                <form action="approved-student-skills.php?result" method="post">
                        ...
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-muted">
                                        <form action="sapproved-student-skills.php?result=" method="post" >
                    ...
                    <table class="mb-0 table table-dark">                        
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result_uncofirmed) > 0)
                                ...
                                while ($row = mysqli_fetch_array($result_uncofirmed)){
                                       $name_skil = $row['Name'];
                                       $sqlSelect_u = "SELECT * FROM skill where Name = '$name_skil' and user_id = '$user_id' and employer_id = '$inst_grads'  and scouted = 2 order by rating DESC";                   
                        ...
                        ?>
                            <tr><td>Skill: <?php echo $name_skil; ?></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
                            <tr>
                                ...
                                <td>
                                    <form action="../api_controller/employ-skill.php" method="post" >
                                        ...
                                        <input name="user_id" id="id" value="<?php echo $scout_employer; ?>" 
                                               type="hidden" class="form-control">
                                        <button type="submit" id="PopoverCustomT-1" class="btn btn-primary btn-sm" name="end-contract">
                                            End Contract
                                        </button>
                                    </form>
                                </td>
                        ...
                        <tbody>
                            <?php
                                    $sqlSelect_uncofirmed = "SELECT * FROM skill where user_id = '$user_id' and scouted = 2";                   
                                    $result_uncofirmed = mysqli_query($conn, $sqlSelect_uncofirmed);
                                    $unconfirmed = mysqli_num_rows($result_uncofirmed);
                                    if (mysqli_num_rows($result_uncofirmed) > 0)
                                        { 
                                        while ($row = mysqli_fetch_array($result_uncofirmed)){
                                               ...
                                               $sqlSelect_log = "SELECT * FROM student where user_id = '$scout_grad'";                   
