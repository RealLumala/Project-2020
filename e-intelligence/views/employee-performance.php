        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <button type="button" data-toggle="tooltip" title="Tooltip" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark">
                    ...
                    <div class="widget-content-outer">
                        <div class="widget-content-wrapper">
                            <div class="widget-content-left">
                                <div class="widget-heading">Registered Employees</div>
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card mb-3 widget-content">
                    <div class="widget-content-outer">
                        <div class="widget-content-wrapper">
                            <div class="widget-content-left">
                                <div class="widget-heading">Confirmed Employees</div>
                                <div class="widget-subheading">Total</div>
                            </div>
                            <div class="widget-content-right">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header">Employee Standings
                        ...
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                            ...
                            <tbody>
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left flex2">
                                                    ...
                                                    <div class="widget-subheading opacity-7">Last Name</div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">DD/MM/YYY</td>
                                    <td class="text-center">
                                        <div class="badge badge-success">Employed</div>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">DD/MM/YYY</td>
                                    <td class="text-center">
                                        <div class="badge badge-danger">Dissised</div>
                                    </td>
                                    <td class="text-center">
