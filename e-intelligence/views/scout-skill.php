                            ...
                            if (mysqli_num_rows($result_uncofirmed) > 0)
                                ...
                                while ($row = mysqli_fetch_array($result_uncofirmed)){
                                       ...
                                       ?>
                                        ...
                                        <?php
                                       $sqlSelect_u = "SELECT * FROM skill where Name = '$name_skil' and user_id != 0 and employer_id != '$user_id' and institution_admin_id = '$inst_grads'  and scouted = 0 order by rating DESC";                   
                                        ...
                                        { 
                                            ...
                                            while ($row = mysqli_fetch_array($result_uncofirmed)){
                                               ...
                                               ?>
                                                 <tr><td><?php echo $sk; ?></td><td>Skill Name: <?php echo $name_skil; ?></td><td></td><td></td><td></td><td></td><td></td></tr>
                                               <?php
                                               $sqlSelect_u = "SELECT * FROM skill where Name = '$name_skil' and user_id != 0 and employer_id = '$user_id' and scouted = 0 order by rating DESC";                   
                                               $result_u = mysqli_query($conn, $sqlSelect_u); 
                                               $u = mysqli_num_rows($result_u);
                                               if (mysqli_num_rows($result_u) > 0){ 
                                                while ($row_ = mysqli_fetch_array($result_u)){
