                    ...
                    <div class="card-header">
                        ...
                        <div class="btn-actions-pane-right">
                            <div role="group" class="btn-group-sm btn-group">
                                <form action="student-approvals.php?result" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="../api_controller/employ-skill.php" method="post" >
                                        ...
                                        <input name="user_id" id="id" value="<?php echo $scout_employer; ?>" 
                                               type="hidden" class="form-control">
                                        <button type="submit" id="PopoverCustomT-1" class="btn btn-primary btn-sm" name="approve-student">
                                            Approve
                                        </button>
                                    </form>
                                </td>
                                <td>
                                    <form action="../api_controller/employ-skill.php" method="post" >
                                        ...
                                        <input name="user_id" id="id" value="<?php echo $scout_employer; ?>" 
                                               type="hidden" class="form-control">
                                        <button type="submit" id="PopoverCustomT-1" class="btn btn-primary btn-sm" name="Dismiss-student">
                                            Dismiss
                                        </button>
                                    </form>
                                </td>
