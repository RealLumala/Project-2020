    ...
    <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">Student List</h5>
                        <div class="outer-container">
                            <form action="../api_controller/upload_student_list.php" method="post"
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            $sqlSelect = "SELECT * FROM student_list Where "
                                    . "institution_admin_id='$institution_id' order by year desc limit 10";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header">
                        Student Lists and Academic Years
                        <div class="btn-actions-pane-right">
                            <div role="group" class="btn-group-sm btn-group">
                                <form action="upload_student_list.php?result" method="post">
                    ...
                    <div class="table-responsive">
                        ...
                        ?>                  
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <form action="student_list_details.php" method="post">
                        ...
                        <?php 
                            ...
                            <?php
                                 $sqlSelect = "SELECT DISTINCT year FROM student_list Where "
