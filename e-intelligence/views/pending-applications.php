                    ...
                    <div class="card-header">
                        ...
                        <div class="btn-actions-pane-right">
                            <div role="group" class="btn-group-sm btn-group">
                                <form action="scout-skill.php?result" method="post">
                ...
                <div class="card-body">
                    ...
                    <table class="mb-0 table table-dark">
                        ...
                        if (isset($_POST['inst_grads'])){                        
                            ...
                            //get number of confirmed students accounts                  
                            $sqlSelect_uncofirmed = "SELECT * FROM skill where user_id = 0 and employer_id = '$user_id' and institution_admin_id = '$inst_grads'";                   
                            $result_uncofirmed = mysqli_query($conn, $sqlSelect_uncofirmed);
                            $unconfirmed = mysqli_num_rows($result_uncofirmed);
                            if (mysqli_num_rows($result_uncofirmed) > 0)
                                { 
                                ...
                                while ($row = mysqli_fetch_array($result_uncofirmed)){
                                       ...
                                       ?>
                                        ...
                                        <?php
                                       $sqlSelect_u = "SELECT * FROM skill where Name = '$name_skil' and user_id != 0 and employer_id = '$user_id' and institution_admin_id = '$inst_grads'  and scouted = 1 order by rating DESC";                   
                                       ...
                                       if (mysqli_num_rows($result_u) > 0){ 
                                        while ($row_ = mysqli_fetch_array($result_u)){
                                               ...
                                               //get number of confirmed students accounts                  
                                               $sql_i = "SELECT * FROM institution_admin where user_id = '$inst_grads'";                   
                        ...
                        ?>
                            <tr>
                                ...
                                <td>Mr. / Miss. <?php //echo $scout_fname; ?> <?php echo $scout_grad; ?></td>
                                <td>
                                        <?php
                                           if ($skill_status == '1'){                                                
                                ...
                                <td>
                                    <form action="../api_controller/employ-skill.php" method="post" >
                                        <input name="scout_id" id="id" value="<?php echo $scout_id; ?>" 
                                               type="hidden" class="form-control">
                                        <input name="user_id" id="id" value="<?php echo $scout_lname; ?>" 
                                               type="hidden" class="form-control">
                                        ...
                                        { 
                                            ...
                                            while ($row = mysqli_fetch_array($result_uncofirmed)){
                                               ...
                                               ?>
                                                 <tr><td><?php echo $sk; ?></td><td>Skill Name: <?php echo $name_skil; ?></td><td></td><td></td><td></td><td></td><td></td></tr>
                                               <?php
                                               $sqlSelect_u = "SELECT * FROM skill where Name = '$name_skil' and user_id != 0 and employer_id = '$user_id' and scouted = 1 order by rating DESC";                   
                                               $result_u = mysqli_query($conn, $sqlSelect_u); 
                                               $u = mysqli_num_rows($result_u);
                                               if (mysqli_num_rows($result_u) > 0){ 
                                                while ($row_ = mysqli_fetch_array($result_u)){
